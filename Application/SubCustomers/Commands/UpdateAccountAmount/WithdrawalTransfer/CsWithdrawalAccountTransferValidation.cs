...
{
    public class CsWithdrawalAccountTransferValidation:AbstractValidator<CsWithdrawalAccountTransferCommand>
    {
        public CsWithdrawalAccountTransferValidation(IApplicationDbContext dbContext,IHttpUserContext httpUserContext)
        {

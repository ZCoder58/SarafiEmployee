...
{
    public class CsWithdrawalAccountValidation:AbstractValidator<CsWithdrawalAccountCommand>
    {
        public CsWithdrawalAccountValidation(IApplicationDbContext dbContext,IHttpUserContext httpUserContext)
        {
            ...
            RuleFor(a => a.SubCustomerAccountRateId)
                ...
                .Must((model, subCustomerAccountRateId) => 
                    dbContext.SubCustomerAccountRates.Any(a =>

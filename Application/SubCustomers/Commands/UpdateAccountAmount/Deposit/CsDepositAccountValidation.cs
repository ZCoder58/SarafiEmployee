...
{
    public class CsDepositAccountValidation:AbstractValidator<CsDepositAccountCommand>
    {
        public CsDepositAccountValidation(IApplicationDbContext dbContext,IHttpUserContext httpUserContext)
        {

...
{
    public class
        GetTransfersBillsQueryHandler : IRequestHandler<GetTransfersBillsQuery, List<TransfersBillsDTo>>
    {
        private readonly IApplicationDbContext _dbContext;
        private readonly IHttpUserContext _httpUserContext;

        public GetTransfersBillsQueryHandler(IApplicationDbContext dbContext, IHttpUserContext httpUserContext)
        {
            _dbContext = dbContext;
            _httpUserContext = httpUserContext;
        }

        public Task<List<TransfersBillsDTo>> Handle(GetTransfersBillsQuery request,

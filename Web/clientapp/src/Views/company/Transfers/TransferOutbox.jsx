            ...
            selector: row => (
                <ListItem sx={{ flexDirection: "column", alignItems: "normal", px: 0 }} >
                    ...
                    <Stack direction="row" spacing={1} justifyContent="flex-end">
                        <Button variant="contained" size="small" onClick={() => navigate("/company/transfers/outbox/" + row.id)}>
                            جزییات
                        </Button>
                        {row.state === -1 &&
                        ...
                        {row.state === 0 &&
                            <Button variant="contained" size="small" onClick={() =>navigate(`/company${row.accountType===1?"/subCustomers":""}/transfers/edit/${row.id}`)}>
                                ویرایش
                            </Button>}
                    </Stack>
                </ListItem>
            ...
            selector: row =>
                <>
                    <CTooltip title="جزییات">
                        <IconButton onClick={() => navigate("/company/transfers/outbox/" + row.id)}>
                            <InfoOutlinedIcon />
                        </IconButton>
                    </CTooltip>
                    {row.state === -1 &&
                    ...
                    {row.state === 0 &&
                        <CTooltip title="ویرایش">
                            <IconButton onClick={() => navigate(`/company${row.accountType===1?"/subCustomers":""}/transfers/edit/${row.id}`)}>
            ...
            <Grid item lg={12} md={12} sm={12} xs={12}>
                ...
                <CToolbar>
                    <CTooltip title="حواله جدید">
                        <IconButton onClick={() => navigate('/company/transfers/newTransfer')}>
                            <AddOutlinedIcon />
                        </IconButton>
                    </CTooltip>
